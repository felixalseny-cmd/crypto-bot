...
✅ High-accuracy FOREX
✅ Wave counting
✅ Trading setup: entry/target/support/resistance
✅ Time frame: M15/H1/H4
✅ Real-time market analysis  
✅ Swing trading & Day trading
✅ Average monthly pips: 3500
...
async function handleBack(chatId, messageId) {
  ...
  // Эмулируем отправку команды /start
  const mockMsg = {
    chat: { 
      id: chatId, 
      first_name: 'User',
  ...
  const startHandler = bot._textRegexpCallbacks[0];
  if (startHandler && startHandler.regexp.test(mockMsg.text)) {
